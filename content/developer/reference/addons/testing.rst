...
should be followed.  The test runner will then create a phantom_js browser, point it to the proper
...
Add your :file:`your_tour.js` as an asset in :file:`your_module_views.xml`.

Then, if not already done, update :file:`__manifest__.py` to load :file:`your_module_views.xml`:

Finally, update :file:`__init__.py` in the folder :file:`tests` to import
:file:`test_calling_the_tour`.

.. seealso::
   - :doc:`../javascript/javascript_reference`, section :ref:`js_reference/adding_assets`
   - :ref:`testing/python`
...
2. Add any step you want:
  ...
  `predefined steps <https://github.com/odoo/odoo/blob/13.0/addons/web_tour/static/src/js/tour_manager.js#L429-L451>`_
...
To start a tour from a python test, make the class inherits from

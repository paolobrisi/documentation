...
.. danger::
   If the **Capture Delay** is not set to **manual** on Adyen but Odoo is configured to capture
   amounts manually, the transaction will be blocked in the authorized state in Odoo.
